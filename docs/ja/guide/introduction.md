...
JiETNG（発音「jie ting」）は、LINE で利用可能な無料で機能豊富なボットで、maimai でらっくす のスコアを自動的に追跡・管理します。公式 SEGA ウェブサイトから直接プレイデータを取得し、美しく分かりやすいビジュアル形式で表示します。
...
JiETNG を使用する何百人もの maimai でらっくす プレイヤーに参加しましょう：
