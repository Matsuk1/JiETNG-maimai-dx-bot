...
不！JiETNG 完全**免费**使用。但是，您可以通过[捐赠](/zh/more/support)支持开发。
...
请参阅[账号绑定](/zh/guide/binding)了解设置说明。
...
详情请参阅 [Best 50 功能](/zh/features/b50)。
...
详情请参阅[好友系统](/zh/features/friends)。
...
您需要 `unbind` 然后使用新版本重新 `bind`。

:::warning
切换版本会删除您当前的数据！确保您想要切换。
:::
...
- 💰 **财务支持**: [捐赠](/zh/more/support)
- ⭐ **GitHub**: 为[仓库](https://github.com/Matsuk1/JiETNG)加星
- 📢 **分享**: 告诉朋友关于 JiETNG
- 📝 **贡献**: 改进文档、修复 bug、添加功能
- 🐛 **报告**: 帮助识别和报告 bug

详情请参阅[支持页面](/zh/more/support)。
