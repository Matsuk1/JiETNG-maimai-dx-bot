...
from modules import record_generator as records
from modules import image_manager
...
class ImageDataTests(unittest.TestCase):
    def test_record_totals_and_escaping(self):
        ...
        with patch('modules.html_cards.thumbnail_html', return_value='card'), patch('modules.html_renderer.render_template') as render:
    ...
    def test_group_order_and_completed_first(self):
        with Image.new('RGBA', (150, 180)) as im:
            ...
            with patch('modules.html_renderer.render_template') as render:
    ...
    def test_two_icons_and_user_text_are_safe(self):
        ...
        with patch('modules.html_cards.icon_uri', side_effect=lambda v,*_: 'data:' + v), patch('modules.html_cards.cover_html', return_value=''):
    ...
    def test_owned_sources_closed_on_render_failure(self):
        ...
        with patch('modules.image_manager.compose_images', side_effect=RuntimeError('failed')):
    ...
    def test_break_loss_totals_preserved(self):
        ...
        with patch('modules.html_renderer.render_template') as render, patch.object(records, 'compose_generated_images'):
