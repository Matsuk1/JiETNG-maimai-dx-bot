...
このドキュメントは、JiETNG Maimai DX LINE Bot で利用可能なすべてのコマンドを記載しています。
...
| コマンド | エイリアス | 説明 |
|---------|-----------|------|
| `check` | `チェック` | Botがオンラインかチェック |
| `network` | `ネットワーク` | ネットワーク接続状態をチェック |
...
| コマンド | エイリアス | 説明 |
|---------|-----------|------|
| `segaid bind` | `sega bind`, `bind`, `segaid バインド`, `sega バインド`, `バインド` | SEGAアカウントを連携 |
...
| `add-friend [フレンドコード]` | `add friend [フレンドコード]`, `addfriend [フレンドコード]`, `フレンド追加 [フレンドコード]` | フレンドを追加 |
| `friend-b50 [フレンドコード]` | `friend b50 [フレンドコード]`, `フレンドb50 [フレンドコード]` | フレンドのB50を表示 |

**例**：
```
friend list                   # フレンドリストを表示
add-friend 1234567890123456   # フレンドを追加
