...
TEXTS["message_manager"] = {'help_ui': {'b_subtitle': 'Best / All Best / special score images and filters',
 ...
 'score_recognition': {'break_detail': 'BREAK Details',
                       ...
                       'calc_consistent_unverified': 'Calc matches the achievement and judgements (chart undetermined)',
                       ...
                       'constant': 'Level',
                       'difficulty_undetermined': 'UNDETERMINED',
...
TEXTS["command_help"] = {'bind': '命令: bind\n'
 ...
 'song_info': '命令: [<song>] info\n'
              ...
              '参数: The title is optional; omit it to query the blank-title song. When replying '
              'to an image, omitting it recognizes the title automatically.\n'
 ...
 'song_record': '命令: [<song>] record\n'
                ...
                '参数: Optional: <song>, placed before record; omit it to query the blank-title song.\n'
                'Matching: if multiple songs match, the bot returns selectable candidates.\n'
                '示例: ヒバナ record',
 'status': '命令: status\n'
...
TEXTS["images"] = {
    ...
    "score": {
        ...
        "difficulty_undetermined": 'UNDETERMINED',
        "metadata_undetermined": 'Chart undetermined',
