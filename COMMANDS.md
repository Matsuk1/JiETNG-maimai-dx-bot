...
本文档列出了 JiETNG Maimai DX LINE Bot 的所有可用命令。

简体中文 | [English](COMMANDS_EN.md) | [日本語](COMMANDS_JP.md)
...
| 命令 | 别名 | 说明 |
|------|------|------|
| `check` | `チェック` | 检查 Bot 是否在线 |
| `network` | `ネットワーク` | 检查网络连接状态 |
...
| 命令 | 别名 | 说明 |
|------|------|------|
| `segaid bind` | `sega bind`, `bind`, `segaid バインド`, `sega バインド`, `バインド` | 绑定 SEGA 账户 |
...
**说明**：等级可以是 1-15 的整数或小数，若为整数则是等级列表，若为小数则是定数列表
...
| `add-friend [好友代码]` | `add friend [好友代码]`, `addfriend [好友代码]`, `フレンド追加 [好友代码]` | 添加好友 |
| `friend-b50 [好友代码]` | `friend b50 [好友代码]`, `フレンドb50 [好友代码]` | 查看好友的 B50 成绩 |

**示例**：
```
friend list                   # 查看好友列表
add-friend 1234567890123456   # 添加好友
...
| 功能 | 说明 |
|------|------|
| 发送图片 | 自动扫描图片中的二维码，识别好友添加链接或其他数据 |
